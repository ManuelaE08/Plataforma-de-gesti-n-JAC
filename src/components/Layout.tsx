...
const nivelBg = {
  success: "bg-green-50", warning: "bg-amber-50",
  error: "bg-red-50",     info: "bg-blue-50",
};
...
function Layout({ children }: LayoutProps) {
  ...
  // IDs leídas y eliminadas (gestionadas localmente en Layout)
  ...
  const eliminarNotif     = (id: string) => {
    ...
    setLeidas((p)     => new Set([...p, id])); // también la marca leída
  };
            ...
            {mostrarBell && (
              <div className="relative" ref={bellRef}>
                ...
                >
                  <Bell size={17} />
                  {sinLeer > 0 && (
                    <span className="absolute -top-0.5 -right-0.5 min-w-[16px] h-4 bg-red-500 text-white text-[9px] font-bold rounded-full flex items-center justify-center px-1 border border-white">
                          ...
                          return (
                            <li
                              ...
                              className={`group px-4 py-3 flex gap-2.5 transition-colors ${
                                esLeida ? "bg-white" : nivelBg[n.nivel]
                            ...
                            >
                              ...
                              <div className="min-w-0 flex-1">
                                <div className="flex items-start justify-between gap-2">
                                  <p className={`text-xs text-gray-800 leading-snug ${esLeida ? "font-normal opacity-70" : "font-semibold"}`}>
                                    {n.titulo}
                                  </p>
